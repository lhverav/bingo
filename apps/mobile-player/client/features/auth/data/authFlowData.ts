...
export const authFlowData: AuthFlow = {
  ...
  "_schema": {
    ...
    "passParams": "Dynamic parameters passed during navigation",
    "receivesParams": "Parameters the screen expects to receive",
    "$context": "Variable from current context (e.g., $oauth_email)"
  },
  "_sharedScreens": [
